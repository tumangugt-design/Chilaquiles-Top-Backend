...
export const INVENTORY_CATALOG = [
  ...
  { name: 'totopos', label: 'Totopos', unit: 'g', category: 'Ingredientes fijos', usedPerPlate: 80 },
  { name: 'queso', label: 'Queso', unit: 'g', category: 'Ingredientes fijos', usedPerPlate: 60 },
